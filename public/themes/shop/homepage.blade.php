...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/schemes/leather.css" title="leather" media="all" />
  </head>
  <body class="boxed">
    <div class="global-wrapper clearfix" id="global-wrapper">
      ...
      <nav class="navbar navbar-default navbar-main-white navbar-pad-top navbar-first">
        <div class="container">
          ...
          <ul class="nav navbar-nav navbar-right navbar-mob-item-left">
            ...
            <li class="dropdown">
              <a href="shopping-cart.html"><span >Your Cart</span><i class="fa fa-shopping-cart"></i> 3 Items</a>
              <ul class="dropdown-menu dropdown-menu-shipping-cart">
                ...
                <li>
                  ...
                  <div class="dropdown-menu-shipping-cart-inner">
                    <p class="dropdown-menu-shipping-cart-price">$70</p>
                ...
                <li>
                  ...
                  <div class="dropdown-menu-shipping-cart-inner">
                    <p class="dropdown-menu-shipping-cart-price">$96</p>
        ...
        <div class="container">
          <div class="collapse navbar-collapse navbar-collapse-no-pad" id="main-nav-collapse">
            <ul class="nav navbar-nav">
              <li class="dropdown">
                <a href="#"><span >Shop by</span>Department<i class="drop-caret" data-toggle="dropdown"></i></a>
                <ul class="dropdown-menu dropdown-menu-category">
                  <li>
                    <a href="#"><i class="fa fa-home dropdown-menu-category-icon"></i>Home & Garden</a>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Home</a>
                                  <p>Nam etiam fringilla hac convallis</p>
                                </li>
                                <li>
                                  <a href="#">Kitchen</a>
                                  <p>Integer facilisi libero massa adipiscing</p>
                                </li>
                                <li>
                                  <a href="#">Furniture & Decor</a>
                                  <p>Montes sodales aenean non dapibus</p>
                                </li>
                                <li>
                                  <a href="#">Bedding & Bath</a>
                                  <p>Purus mollis convallis risus tempus</p>
                                </li>
                                <li>
                                  <a href="#">Appilances</a>
                                  <p>Id arcu leo lobortis integer</p>
                                </li>
                                <li>
                                  <a href="#">Patio, Lawn & Garden</a>
                                  <p>Hac rutrum egestas vel malesuada</p>
                                </li>
                                <li>
                                  <a href="#">Wedding Registry</a>
                                  <p>Tellus himenaeos suspendisse ligula faucibus</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Nulla luctus platea dis dolor</p>
                                </li>
                                <li>
                                  <a href="#">Lamps & Light Fixtures</a>
                                  <p>Ornare dapibus consectetur sit praesent</p>
                                </li>
                                <li>
                                  <a href="#">Kitchen & Bath Fixtures</a>
                                  <p>Hendrerit dapibus potenti metus enim</p>
                                </li>
                                <li>
                                  <a href="#">Home Automation</a>
                                  <p>Varius neque ipsum eu mollis</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-diamond dropdown-menu-category-icon"></i>Jewelry</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Necklances & Pendants</a>
                                  <p>Parturient eleifend leo montes orci</p>
                                </li>
                                <li>
                                  <a href="#">Bracelets</a>
                                  <p>Feugiat dis aptent ridiculus molestie</p>
                                </li>
                                <li>
                                  <a href="#">Rings</a>
                                  <p>Mattis penatibus quisque dis suscipit</p>
                                </li>
                                <li>
                                  <a href="#">Errings</a>
                                  <p>Lorem sit dapibus dignissim at</p>
                                </li>
                                <li>
                                  <a href="#">Wedding & Engagement</a>
                                  <p>Placerat rutrum vulputate mollis mus</p>
                                </li>
                                <li>
                                  <a href="#">Charms</a>
                                  <p>Tincidunt elementum maecenas curae sit</p>
                                </li>
                                <li>
                                  <a href="#">Booches</a>
                                  <p>Imperdiet a potenti lectus interdum</p>
                                </li>
                                <li>
                                  <a href="#">Men's Jewelry</a>
                                  <p>Phasellus varius bibendum rhoncus nostra</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Contemporary & Designer</a>
                                  <p>Aptent neque lectus inceptos risus</p>
                                </li>
                                <li>
                                  <a href="#">Juniors</a>
                                  <p>Facilisi torquent consequat fermentum arcu</p>
                                </li>
                                <li>
                                  <a href="#">Meternity</a>
                                  <p>Blandit imperdiet ipsum egestas massa</p>
                                </li>
                                <li>
                                  <a href="#">Pettite</a>
                                  <p>Eu et nullam condimentum integer</p>
                                </li>
                                <li>
                                  <a href="#">Uniforms, Works & Safety</a>
                                  <p>Non non hac sociosqu parturient</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-child dropdown-menu-category-icon"></i>Toy & Kids</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Adipiscing elementum dignissim congue donec</p>
                                </li>
                                <li>
                                  <a href="#">Active Wear</a>
                                  <p>Dui montes donec ac elementum</p>
                                </li>
                                <li>
                                  <a href="#">Coats & Jackets</a>
                                  <p>Malesuada penatibus rhoncus sed cum</p>
                                </li>
                                <li>
                                  <a href="#">Jeans</a>
                                  <p>Porta feugiat suspendisse blandit adipiscing</p>
                                </li>
                                <li>
                                  <a href="#">Sets</a>
                                  <p>Aliquet tincidunt integer taciti proin</p>
                                </li>
                                <li>
                                  <a href="#">Indoors</a>
                                  <p>Sollicitudin platea varius rhoncus dui</p>
                                </li>
                                <li>
                                  <a href="#">Swimwear</a>
                                  <p>Aptent litora vivamus vel augue</p>
                                </li>
                                <li>
                                  <a href="#">Special Occasion</a>
                                  <p>Curae potenti molestie suscipit elementum</p>
                                </li>
                                <li>
                                  <a href="#">Shoes</a>
                                  <p>Sem ultrices vivamus lacus nostra</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Nibh morbi vehicula vitae massa</p>
                                </li>
                                <li>
                                  <a href="#">Kids Jewelry & Watches</a>
                                  <p>Curae massa eget cubilia tortor</p>
                                </li>
                                <li>
                                  <a href="#">Toys & Games</a>
                                  <p>Fringilla egestas litora hac cubilia</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-plug dropdown-menu-category-icon"></i>Electronics</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">TV & Video</a>
                                  <p>Fames ut orci cum faucibus</p>
                                </li>
                                <li>
                                  <a href="#">Home Audio & Theater</a>
                                  <p>Molestie fusce augue netus pretium</p>
                                </li>
                                <li>
                                  <a href="#">Camera, Photo & Video</a>
                                  <p>Molestie cum viverra lorem sociis</p>
                                </li>
                                <li>
                                  <a href="#">Cell Phones & Accessories</a>
                                  <p>Auctor sociosqu erat feugiat auctor</p>
                                </li>
                                <li>
                                  <a href="#">Headphones</a>
                                  <p>Volutpat aliquam nisl taciti sapien</p>
                                </li>
                                <li>
                                  <a href="#">Video Games</a>
                                  <p>Etiam rhoncus pharetra blandit velit</p>
                                </li>
                                <li>
                                  <a href="#">Gar Electronics</a>
                                  <p>Integer duis dui mollis nisl</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Potenti ad vulputate vitae tempor</p>
                                </li>
                                <li>
                                  <a href="#">Desktops & Monitors</a>
                                  <p>Sodales sapien nibh ultricies molestie</p>
                                </li>
                                <li>
                                  <a href="#">Computer Accessories</a>
                                  <p>Tristique at neque lacus sapien</p>
                                </li>
                                <li>
                                  <a href="#">Software</a>
                                  <p>Luctus auctor imperdiet lacus lacus</p>
                                </li>
                                <li>
                                  <a href="#">Printers & Ink</a>
                                  <p>Commodo proin eu accumsan torquent</p>
                                </li>
                                <li>
                                  <a href="#">Networking</a>
                                  <p>Fermentum fermentum senectus dapibus magnis</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-tags dropdown-menu-category-icon"></i>Clothes & Shoes</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Woman</a>
                                  <p>Accumsan vehicula cum commodo fringilla</p>
                                </li>
                                <li>
                                  <a href="#">Men</a>
                                  <p>Viverra montes lobortis pulvinar aenean</p>
                                </li>
                                <li>
                                  <a href="#">Girls</a>
                                  <p>Neque ligula donec per vitae</p>
                                </li>
                                <li>
                                  <a href="#">Boys</a>
                                  <p>Integer donec ac varius curabitur</p>
                                </li>
                                <li>
                                  <a href="#">Baby</a>
                                  <p>Porttitor nullam donec ante cursus</p>
                                </li>
                                <li>
                                  <a href="#">Luggage</a>
                                  <p>Nunc viverra ut nam non</p>
                                </li>
                                <li>
                                  <a href="#">Accessories</a>
                                  <p>Vulputate curabitur hendrerit pellentesque ligula</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-futbol-o dropdown-menu-category-icon"></i>Sports</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Mus mollis himenaeos class lorem</p>
                                </li>
                                <li>
                                  <a href="#">Exorcise & Fitness</a>
                                  <p>Nam sociis congue quis imperdiet</p>
                                </li>
                                <li>
                                  <a href="#">Hunting & Fishing</a>
                                  <p>Ornare elementum quam magnis turpis</p>
                                </li>
                                <li>
                                  <a href="#">Team Sports</a>
                                  <p>Platea facilisis sollicitudin dolor dignissim</p>
                                </li>
                                <li>
                                  <a href="#">Fan Sports</a>
                                  <p>Pulvinar ultrices nullam vel ultricies</p>
                                </li>
                                <li>
                                  <a href="#">Golf</a>
                                  <p>Phasellus risus porttitor dignissim nibh</p>
                                </li>
                                <li>
                                  <a href="#">Sports Collections</a>
                                  <p>Purus ornare imperdiet nullam convallis</p>
                                </li>
                                <li>
                                  <a href="#">Camping & Hiking</a>
                                  <p>Mattis sollicitudin enim ad mauris</p>
                                </li>
                                <li>
                                  <a href="#">Cycling</a>
                                  <p>Lacus lectus a iaculis lorem</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-music dropdown-menu-category-icon"></i>Entertaiment</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Pellentesque dictum felis semper tellus</p>
                                </li>
                                <li>
                                  <a href="#">Music</a>
                                  <p>Cum ante sed mus vulputate</p>
                                </li>
                                <li>
                                  <a href="#">DVD & Movies</a>
                                  <p>Scelerisque eu per fermentum etiam</p>
                                </li>
                                <li>
                                  <a href="#">Tickets</a>
                                  <p>Nisi platea dui posuere nibh</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-location-arrow dropdown-menu-category-icon"></i>Travel</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Luggage</a>
                                  <p>Netus eros sed nisl senectus</p>
                                </li>
                                <li>
                                  <a href="#">Travel Accessories</a>
                                  <p>Natoque sapien maecenas himenaeos proin</p>
                                </li>
                                <li>
                                  <a href="#">Luggage Accessories</a>
                                  <p>In natoque porta sociis semper</p>
                                </li>
                                <li>
                                  <a href="#">Lodging</a>
                                  <p>Posuere rhoncus lorem rutrum elit</p>
                                </li>
                                <li>
                                  <a href="#">Maps</a>
                                  <p>Arcu purus mauris adipiscing molestie</p>
                                </li>
                                <li>
                                  <a href="#">Other Travel</a>
                                  <p>Elementum primis id per ante</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Orci dapibus justo ridiculus vivamus</p>
                                </li>
                                <li>
                                  <a href="#">Campground & RV</a>
                                  <p>Primis est massa vel turpis</p>
                                </li>
                                <li>
                                  <a href="#">Rail</a>
                                  <p>Diam sociosqu eu aliquet non</p>
                                </li>
                                <li>
                                  <a href="#">Car Rental</a>
                                  <p>Suspendisse dignissim vivamus mollis dapibus</p>
                                </li>
                                <li>
                                  <a href="#">Cruises</a>
                                  <p>In arcu lectus taciti congue</p>
                                </li>
                                <li>
                                  <a href="#">Airline</a>
                                  <p>Cras etiam mi aptent montes</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-picture-o dropdown-menu-category-icon"></i>Art & Design</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Paintings from Dealers & Resellers</a>
                                  <p>Mauris eros ligula conubia convallis</p>
                                </li>
                                <li>
                                  <a href="#">Paintings Direct from Artist</a>
                                  <p>Pellentesque adipiscing eleifend netus semper</p>
                                </li>
                                <li>
                                  <a href="#">Art Prints</a>
                                  <p>Viverra posuere sollicitudin felis ante</p>
                                </li>
                                <li>
                                  <a href="#">Art Photographs from Resellers</a>
                                  <p>Tincidunt inceptos eros lectus nulla</p>
                                </li>
                                <li>
                                  <a href="#">Art Photographs from the Artist</a>
                                  <p>Dignissim elit tempor enim porta</p>
                                </li>
                                <li>
                                  <a href="#">Art Posters</a>
                                  <p>Hac nec nulla torquent dis</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Home Decor Decals</a>
                                  <p>Erat augue elit suscipit cubilia</p>
                                </li>
                                <li>
                                  <a href="#">Furniture</a>
                                  <p>Ligula potenti ultrices vehicula consectetur</p>
                                </li>
                                <li>
                                  <a href="#">Wallpapers</a>
                                  <p>Risus magnis tincidunt tempus integer</p>
                                </li>
                                <li>
                                  <a href="#">Bar Flasks</a>
                                  <p>Dapibus placerat congue arcu aliquet</p>
                                </li>
                                <li>
                                  <a href="#">Posters & Prints</a>
                                  <p>Nam orci potenti platea eleifend</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-motorcycle dropdown-menu-category-icon"></i>Motors</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Semper sociis eget ultrices maecenas</p>
                                </li>
                                <li>
                                  <a href="#">Cars & Trucks</a>
                                  <p>Imperdiet elementum fringilla viverra sodales</p>
                                </li>
                                <li>
                                  <a href="#">Motorcycles</a>
                                  <p>Semper porttitor cursus diam mus</p>
                                </li>
                                <li>
                                  <a href="#">Passenger Vehicles</a>
                                  <p>Pulvinar hendrerit sollicitudin mus per</p>
                                </li>
                                <li>
                                  <a href="#">Industry Vehicles</a>
                                  <p>Lacus sociis inceptos dolor posuere</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-paw dropdown-menu-category-icon"></i>Pets</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Backyard Poultry Supplies</a>
                                  <p>Habitasse metus malesuada ridiculus praesent</p>
                                </li>
                                <li>
                                  <a href="#">Bird Supplies</a>
                                  <p>Fames laoreet placerat metus nascetur</p>
                                </li>
                                <li>
                                  <a href="#">Cat Supplies</a>
                                  <p>Commodo lectus eleifend inceptos praesent</p>
                                </li>
                                <li>
                                  <a href="#">Dog Supplies</a>
                                  <p>Tellus semper imperdiet ac felis</p>
                                </li>
                                <li>
                                  <a href="#">Pet Memorials & Urns</a>
                                  <p>Pulvinar nunc dictumst odio vitae</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-4">
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  ...
                                  <p>Primis vestibulum curae volutpat rhoncus</p>
                                </li>
                                <li>
                                  <a href="#">Horse Supplies</a>
                                  <p>Nec proin quam gravida proin</p>
                                </li>
                                <li>
                                  <a href="#">Reptile Supplies</a>
                                  <p>Potenti primis morbi parturient ultricies</p>
                                </li>
                                <li>
                                  <a href="#">Small Animal Supplies</a>
                                  <p>Torquent viverra aptent pretium posuere</p>
                                </li>
                              </ul>
                            </div>
                            <div class="col-md-4">
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Wholesale Lots</a>
                                  <p>Proin curabitur vehicula curabitur inceptos</p>
                                </li>
                                <li>
                                  <a href="#">Other Pet Supplies</a>
                                  <p>Phasellus vehicula placerat at sociosqu</p>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-cubes dropdown-menu-category-icon"></i>Hobbies & DIY</a>
                    <div class="dropdown-menu-category-section">
                      <div class="dropdown-menu-category-section-inner">
                        <div class="dropdown-menu-category-section-content">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul class="dropdown-menu-category-list">
                                <li>
                                  <a href="#">Model & Kit Tools</a>
                                  <p>Nisi dignissim nam aliquam congue</p>
                                </li>
                                <li>
                                  <a href="#">Supplies & Engines</a>
                                  <p>Mauris lobortis quis sociosqu lorem</p>
                                </li>
                                <li>
                                  <a href="#">RC Airline & Helicopter</a>
                                  <p>Cras pretium quam parturient euismod</p>
                                </li>
                                <li>
                                  <a href="#">RC Car, Truck & motorcycle</a>
                                  <p>Et fermentum curabitur cubilia elit</p>
                                </li>
                                <li>
                                  <a href="#">Military Airline Models & Kits</a>
                                  <p>Mattis nascetur ipsum vulputate sapien</p>
                                </li>
                                <li>
                                  <a href="#">Craft Airbrushing Supplies</a>
                                  <p>Viverra fermentum habitasse cras ac</p>
                                </li>
                                <li>
                                  <a href="#">Card Making Supplies</a>
                                  <p>Nibh phasellus accumsan praesent laoreet</p>
                                </li>
                                <li>
                                  <a href="#">Craft Sewing</a>
                                  <p>Scelerisque id potenti nec auctor</p>
                                </li>
                              </ul>
                            </div>
                          </div>
              ...
              <li class="dropdown yamm-fw">
                <a class="navbar-item-top" href="#">Pages<i class="drop-caret" data-toggle="dropdown"></i></a>
                  ...
                  <li class="yamm-content">
                    <div class="row row-eq-height row-col-border">
                      ...
                      <div class="col-md-2">
                        ...
                        <ul class="dropdown-menu-items-list">
                          <li>
                            <a href="product-page.html">Layout 1</a>
                            <p class="dropdown-menu-items-list-desc">Default Layout</p>
                          </li>
                          <li>
                            <a href="product-layout-2.html">Layout 2</a>
                            <p class="dropdown-menu-items-list-desc">No Sidebar</p>
                          </li>
                          <li>
                            <a href="product-layout-3.html">Layout 3</a>
                            <p class="dropdown-menu-items-list-desc">Full Area Layout + Banners</p>
                          </li>
                          <li>
                            <a href="product-layout-4.html">Layout 4</a>
                            <p class="dropdown-menu-items-list-desc">Gallery Style</p>
                          </li>
                          <li>
                            <a href="product-layout-5.html">Layout 5</a>
                            <p class="dropdown-menu-items-list-desc">Sidebar Right</p>
                          </li>
                          <li>
                            <a href="product-layout-6.html">Layout 6</a>
                            <p class="dropdown-menu-items-list-desc">Sidebar Left</p>
                          </li>
                          <li>
                            <a href="product-layout-7.html">Layout 7</a>
                            <p class="dropdown-menu-items-list-desc">Product Gallery Left</p>
                          </li>
                          <li>
                            <a href="product-layout-8.html">Layout 8</a>
                      ...
                      <div class="col-md-2">
                        ...
                        <ul class="dropdown-menu-items-list">
                          ...
                          <li>
                            <a href="index-footer-layout-2.html">Layout 2</a>
            ...
            <div class="container">
              <div class="slider-item-inner">
                <div class="slider-item-caption-left">
                  ...
                  <p class="slider-item-caption-desc">This is for The Players</p>
                  <a class="btn btn-lg btn-ghost btn-black" href="#">Shop Now</a>
                </div>
                <img class="slider-item-img-right" src="img/test_slider/13.png" alt="Image Alternative text" title="Image Title" style="top: 60%; width: 56%;" />
              </div>
            </div>
          </div>
        </div>
        <div class="owl-item">
          <div class="slider-item" style="background-image:url(img/smart-watch-apple-technology-style-821557_1400x500.jpg);">
            <div class="container">
              <div class="slider-item-inner">
                <div class="slider-item-caption-right slider-item-caption-white">
                  <h4 class="slider-item-caption-title">Smart Watches</h4>
                  <p class="slider-item-caption-desc">Get One Just from $99</p>
            ...
            <div class="container">
              <div class="slider-item-inner">
                <div class="slider-item-caption-left">
                  ...
                  <p class="slider-item-caption-desc">Your Running Shoes, Right Away.</p>
                  <a class="btn btn-lg btn-ghost btn-black" href="#">Shop Now</a>
                </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":5,"loop":true,"nav":true}'>
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/man_fashion/4.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-caption">
                ...
                <div class="product-caption-price"><span class="product-caption-price-new">$102</span>
                </div>
                <ul class="product-caption-feature-list">
                  <li>Free Shipping</li>
                </ul>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/man_fashion/1.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
                ...
                <h5 class="product-caption-title">Alpine Swiss Beck Mens Suede Chukka Desert Boots Lace Up Shoes Crepe Sole Oxford</h5>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/sports/6.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
                ...
                <div class="product-caption-price"><span class="product-caption-price-old">$130</span><span class="product-caption-price-new">$65</span>
                </div>
                <ul class="product-caption-feature-list">
                  <li>Free Shipping</li>
                </ul>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/32.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/laptops/5.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/sports/4.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
        ...
        <div class="row" data-gutter="15">
          <div class="col-md-4">
            <div class="banner banner-o-hid" style="background-image:url(img/landscape-scotland-nature_380x220.jpg);">
              ...
              <img class="banner-img" src="img/test_banner/16.png" alt="Image Alternative text" title="Image Title" style="bottom: -68px; right: -32px; width: 200px;" />
            </div>
          </div>
          <div class="col-md-8">
            <div class="banner banner-o-hid" style="background-image:url(img/pier-jetty-ocean-sea-water-way_750x200.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
          ...
          <div class="col-md-6">
            <div class="banner banner-o-hid" style="background-color:#EA873B;">
              ...
              <img class="banner-img" src="img/test_banner/17.png" alt="Image Alternative text" title="Image Title" style="top: 17px; right: -45px; width: 350px;" />
            </div>
          </div>
          <div class="col-md-6">
            <div class="banner banner-o-hid" style="background-image:url(img/test_banner/19.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
              ...
              <img class="banner-img" src="img/test_banner/18.png" alt="Image Alternative text" title="Image Title" style="top: 17px; right: -45px; width: 350px;" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="banner banner-o-hid" style="background-image:url(img/apple-education-school-knowledge_380x200.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
              ...
              <img class="banner-img" src="img/test_banner/20.png" alt="Image Alternative text" title="Image Title" style="bottom: -20px; right: -60px; width: 240px;" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="banner banner-o-hid" style="background-image:url(img/test_banner/22.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
              ...
              <img class="banner-img" src="img/test_banner/21.png" alt="Image Alternative text" title="Image Title" style="bottom: -29px; right: -51px; width: 240px;" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="banner banner-o-hid" style="background-image:url(img/light-interior-design-tv_380x200.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
              ...
              <img class="banner-img" src="img/test_banner/23.png" alt="Image Alternative text" title="Image Title" style="bottom: -118px; right: 8px; width: 190px;" />
            </div>
          </div>
        </div>
        <div class="gap"></div>
        ...
        <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":5,"loop":true,"nav":true}'>
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/man_fashion/7.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-caption">
                ...
                <div class="product-caption-price"><span class="product-caption-price-old">$129</span><span class="product-caption-price-new">$39</span>
                </div>
                <ul class="product-caption-feature-list">
                  <li>1 left</li>
                  <li>Free Shipping</li>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              ...
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/woman_bags/4.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              <ul class="product-labels"></ul>
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/sports/5.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              <ul class="product-labels"></ul>
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/33.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
        ...
        <div class="row" data-gutter="15">
          <div class="col-md-6">
            <div class="banner banner-o-hid" style="background-image:url(img/girl-portrait-carnival-retro-524141_600x300.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
          ...
          <div class="col-md-6">
            <div class="banner banner-o-hid" style="background-image:url(img/pyrenees-mountains-snow-zenith-351266_600x300.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
              ...
              <img class="banner-img" src="img/test_banner/24.png" alt="Image Alternative text" title="Image Title" style="top: -10px; right: 0; width: 270px;" />
            </div>
          </div>
        </div>
        <div class="gap"></div>
        ...
        <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":7,"loop":true,"nav":true}'>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">241 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">656 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">316 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">500 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">143 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">520 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
          ...
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">682 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
          ...
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">207 products</p>
            </a>
          </div>
          <div class="owl-item">
            <a class="banner-category owl-item-slide" href="#">
              ...
              <p class="banner-category-desc">579 products</p>
            </a>
          </div>
        </div>
        <div class="gap"></div>
        ...
        <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":7,"loop":true,"nav":true}'>
          ...
          <div class="owl-item">
            <div class="product product-sm owl-item-slide">
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/26.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
          ...
          <div class="owl-item">
            <div class="product product-sm owl-item-slide">
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/man_fashion/3.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
                ...
                <h5 class="product-caption-title">T-Tech by Tumi Men's Softshell Jacket</h5>
                <div class="product-caption-price"><span class="product-caption-price-new">$72</span>
                </div>
              </div>
            </div>
          ...
          <div class="owl-item">
            <div class="product product-sm owl-item-slide">
              <div class="product-img-wrap">
                <img class="product-img" src="img/test_product/man_fashion/13.jpg" alt="Image Alternative text" title="Image Title" />
              </div>
              <a class="product-link" href="#"></a>
              <div class="product-caption">
                <ul class="product-caption-rating">
        ...
        <div class="row" data-gutter="15">
          <div class="col-md-12">
            <div class="banner banner-o-hid" style="background-image:url(img/smart-watch-apple-technology-style-821557_1140x200.jpg);">
              <a class="banner-link" href="#"></a>
              <div class="banner-caption-left">
        ...
        <div class="container">
          <div class="row row-col-gap" data-gutter="60">
            <div class="col-md-3">
              ...
              <p>Per nec integer bibendum montes malesuada libero nam libero nostra nec gravida</p>
